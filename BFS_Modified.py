#This implementation shows the minimum distance must take from city 1 - 11
#It does not take the number of cities visited into account
#This is not a strict implementation of the BFS algorithm
...
def BFS(queue): #queue is a queue of pointers to city objects
    while(queue):
        ...
        for city in currCity.cities: #Grab left most element from queue
            ...
            if(distance < cityArr[city - 1].distance):
